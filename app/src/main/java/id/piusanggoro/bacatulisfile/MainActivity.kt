...
// untuk memproses button setelah di klik ( id btnWrite)
...
// untuk memproses button setelah di klik ( id btnRead)
...
// untuk memproses button setelah di klik ( id btnDelete)
